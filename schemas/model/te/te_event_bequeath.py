...
class TEEventBequeath(object):
    ...
    def __init__(self, testator=None, asset=None, benefactor=None, bequest_condition=None, asset_quantifier=None, distribution=None):  # noqa: E501
