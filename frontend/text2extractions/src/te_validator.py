...
if __name__ == "__main__":
    te_directory = "Replace with your TE output directory path"  # Replace with your TE output directory path
    text_directory = "Replace with your original text directory path"  # Replace with your original text directory path
    output_directory = "Replace with your desired output directory path"  # Replace with your desired output directory path
